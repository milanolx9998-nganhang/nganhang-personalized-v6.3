...
- **V6.6.7.4 — mã câu cho mọi môn + file mẫu có ví dụ / lệnh AI + gom lối vào (2026-09-26). Đã lên web: `main` = `0e9a809` (anh Hiếu "up", thứ Bảy 13:43; CI run 36224598323 SUCCESS: Verify 54 giây, Deploy 35 giây; migration v6674 chạy trong deploy). Chưa kiểm giao diện web thật (cần đăng nhập).**
