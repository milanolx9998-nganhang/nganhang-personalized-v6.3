...
- nhánh đi trước `main`: nhãn nguồn `L.2` / `L.2.1` cho mọi màn hiện mã Outcome/YCCĐ (API thêm `outcome_label`/`yccd_label`, mã máy giữ nguyên để đối chiếu) — chờ anh Hiếu bảo đẩy main;
