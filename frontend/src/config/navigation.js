...
export const staffGroups=[
 ...
 // V6.6.7.4: chương trình (Chủ đề/Outcome, YCCĐ, Bài) của mọi môn nạp / sửa / công bố ở MỘT trang "Chương trình môn học".
 // Công cụ cũ / nâng cao (liên kết Bài–YCCĐ bằng tay, danh mục Môn · Chương · Bài) chỉ còn trong nhóm quản trị.
 {id:'content',label:'Ngân hàng & Nội dung',description:'Biên soạn, nhập và duyệt câu hỏi theo môn.',children:[{to:'/practice/banks',label:'Ngân hàng câu hỏi',capabilities:['content.read']},{to:'/curriculum',label:'Chương trình môn học',capabilities:['curriculum.read']},{to:'/tags',label:'Nhãn',capabilities:['content.write']}]},
