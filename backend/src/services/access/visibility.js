...
const metadata=['id','question_id','question_version_id','version_number','question_code','subject_id','branch_id','topic_id','grade','outcome_id','yccd_id','outcome_label','yccd_label','cognitive_level','q_type','main_topic','sub_topic','score','creator_name','creator_id','status','review_status','is_locked','usage_count','last_used_at','family_code','created_at','updated_at','reviewed_by','approved_by','bank_id','lifecycle','current_version_id','active_version_id','metadata_revision','quarantined','subject_name','subject_code','topic_name','branch_name','outcome_code','yccd_code','bank_name','assigned_score','sequence','exam_code','question_order','original_question_id','legacy_unverifiable','answer_hidden'];
const curriculum=['subject_id','grade','branch_id','branch_name','topic_id','topic_name','outcome_id','outcome_code','outcome_label','outcome_text','yccd_id','yccd_code','yccd_label','yccd_text','cognitive_level','revision','historical_labels_unavailable'];
