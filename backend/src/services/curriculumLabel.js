...
// NULLIF: mã phân môn rỗng ('') phải coi như không có, nếu không nhãn thành ".2.1".
export const outcomeLabelSql = (o = 'o') => `COALESCE(NULLIF(${o}.source_branch_code,'')||'.'||${o}.source_ordinal,${o}.code)`;
export const yccdLabelSql = (y = 'y', o = 'o') => `COALESCE(NULLIF(${o}.source_branch_code,'')||'.'||${o}.source_ordinal||'.'||${y}.source_ordinal,${y}.code)`;
