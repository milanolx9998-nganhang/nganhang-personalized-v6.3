...
export async function curriculumCatalog(query={},client=pool){
 ...
 return (await client.query(`SELECT y.*,y.code AS yccd_code,y.text AS yccd_text,o.code AS outcome_code,o.title AS outcome_title,o.subject_id,o.grade,o.domain_code,o.curriculum_version,o.source_document,
